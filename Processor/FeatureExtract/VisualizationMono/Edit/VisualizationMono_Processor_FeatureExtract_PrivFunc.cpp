...
#include "../NoEdit/VisualizationMono_Processor_FeatureExtract_PrivFunc.h"
...
bool DECOFUNC(setParamsVarsOpenNode)(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
{
	...
	VisualizationMono_Processor_FeatureExtract_Params * params=(VisualizationMono_Processor_FeatureExtract_Params *)paramsPtr;
	VisualizationMono_Processor_FeatureExtract_Vars * vars=(VisualizationMono_Processor_FeatureExtract_Vars *)varsPtr;
...
bool DECOFUNC(processMonoDrainData)(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
{
	VisualizationMono_Processor_FeatureExtract_Params * params=(VisualizationMono_Processor_FeatureExtract_Params *)paramsPtr;
	VisualizationMono_Processor_FeatureExtract_Vars * vars=(VisualizationMono_Processor_FeatureExtract_Vars *)varsPtr;
	QVector<ProcessorMulti_Processor_FeatureExtract_Params *> drainparams; copyQVector(drainparams,drainParams);
	QVector<ProcessorMulti_Processor_FeatureExtract_Data *> draindata; copyQVector(draindata,drainData);
	if(draindata.size()==0){return 0;}
	/*======Please Program below======*/
	/*
	Function: process draindata.
	*/
    cv::Mat image = draindata.front()->mapImage;
