...
#ifndef PROCESSORMULTI_PROCESSOR_PATHGENERATOR_PRIVFUNC_H
#define PROCESSORMULTI_PROCESSOR_PATHGENERATOR_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup ProcessorMulti_Processor_PathGenerator_PrivFunc ProcessorMulti_Processor_PathGenerator_PrivFunc
	\ingroup ProcessorMulti_Processor_PathGenerator
	\brief ProcessorMulti_Processor_PathGenerator_PrivFunc defines the PrivFunc in ProcessorMulti_Processor_PathGenerator.
*/

/*! \addtogroup ProcessorMulti_Processor_PathGenerator_PrivFunc
	@{
*/

/*! \file ProcessorMulti_Processor_PathGenerator_PrivFunc.h
	 Defines the PrivFunc of ProcessorMulti_Processor_PathGenerator
*/

//*******************Please add other headers below*******************


#include "../Edit/ProcessorMulti_Processor_PathGenerator_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG ProcessorMulti_Processor_PathGenerator

/*! bool ProcessorMulti_Processor_PathGenerator_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool ProcessorMulti_Processor_PathGenerator_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void ProcessorMulti_Processor_PathGenerator_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void ProcessorMulti_Processor_PathGenerator_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! void ProcessorMulti_Processor_PathGenerator_getMultiInputDataSize(void * paramsPtr, void * varsPtr, QList<int> & inputDataSize)
...
/*! bool ProcessorMulti_Processor_PathGenerator_processMultiInputData(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
